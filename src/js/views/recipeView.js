...
class RecipeView extends View {
    ...
    _errorMeessage = 'We could not find the recipe. Please try another one!';
    _successMessage = '';
    ...
    _generateMarkupIngredient(ing) {
        ...
        return `
            <li class="recipe__ingredient">
                ...
                <div class="recipe__quantity">${ing.quantity ? new Fraction(ing.quantity).toString() : ''}${ing.unit}</div>
